...
import com.pat.portfolio.core.constants.Font.MAIN_TITLE_SIZE_LARGE
...
fun MainSubtitle(
    ...
    H2(
        attrs = Modifier
            ...
            .fontSize(
                when {
                    breakpoint >= Breakpoint.LG -> MAIN_TITLE_SIZE_LARGE
                    breakpoint >= Breakpoint.MD -> MAIN_TITLE_SIZE
                    else -> MAIN_TITLE_SIZE_SMALL
                }
            )
